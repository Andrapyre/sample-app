...
export default function DevicesDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchDeviceData = () => {
      ...
      const recent = [...allDevices].sort((a, b) => 
  ...
  const getDeviceIcon = (type: string) => {
    switch (type) {
      case 'camera': return <CameraIcon sx={{ fontSize: 40 }} color="primary" />;
      case 'microscope': return <MicroscopeIcon sx={{ fontSize: 40 }} color="primary" />;
      case 'sensor': return <SensorIcon sx={{ fontSize: 40 }} color="primary" />;
      default: return <DashboardIcon sx={{ fontSize: 40 }} color="primary" />;
    }
  };
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', py: 4 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Paper elevation={2} sx={{ p: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Typography variant="h6" color="text.secondary" gutterBottom>Total Devices</Typography>
            <Typography variant="h3" color="primary">{deviceStats.total}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper elevation={2} sx={{ p: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Typography variant="h6" color="text.secondary" gutterBottom>Online</Typography>
            <Typography variant="h3" color="success.main">{deviceStats.online}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper elevation={2} sx={{ p: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Typography variant="h6" color="text.secondary" gutterBottom>Offline</Typography>
            <Typography variant="h3" color="error.main">{deviceStats.offline}</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper elevation={2} sx={{ p: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Typography variant="h6" color="text.secondary" gutterBottom>Maintenance</Typography>
            <Typography variant="h3" color="warning.main">{deviceStats.maintenance}</Typography>
          </Paper>
        </Grid>
      </Grid>

      {/* Device Type Cards */}
      <Typography variant="h5" sx={{ mb: 2 }}>Device Categories</Typography>
      <Grid container spacing={3} sx={{ mb: 4 }}>
          ...
          <Card sx={{ height: '100%' }}>
            <CardActionArea onClick={() => navigateToDeviceType('camera')}>
              <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', p: 3 }}>
                ...
                <Typography variant="h5" gutterBottom>Cameras</Typography>
                <Typography variant="h4" color="primary.main">{deviceStats.cameras}</Typography>
          ...
          <Card sx={{ height: '100%' }}>
            <CardActionArea onClick={() => navigateToDeviceType('microscope')}>
              <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', p: 3 }}>
                ...
                <Typography variant="h5" gutterBottom>Microscopes</Typography>
                <Typography variant="h4" color="primary.main">{deviceStats.microscopes}</Typography>
                <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
          ...
          <Card sx={{ height: '100%' }}>
            <CardActionArea onClick={() => navigateToDeviceType('sensor')}>
              <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', p: 3 }}>
                ...
                <Typography variant="h4" color="primary.main">{deviceStats.sensors}</Typography>
                <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
      ...
      {/* Recent Devices */}
      <Typography variant="h5" sx={{ mb: 2 }}>Recently Updated Devices</Typography>
